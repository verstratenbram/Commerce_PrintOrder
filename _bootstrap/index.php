...
if (!createObject('modNamespace',array(
    'name' => 'commerce_printorder',
    'path' => $componentPath.'/core/components/commerce_printorder/',
    'assets_path' => $componentPath.'/assets/components/commerce_printorder/',
),'name', false)) {
    echo "Error creating namespace commerce_printorder.\n";
}

/* Path settings */
if (!createObject('modSystemSetting', array(
    'key' => 'commerce_printorder.core_path',
    'value' => $componentPath.'/core/components/commerce_printorder/',
    'xtype' => 'textfield',
    'namespace' => 'commerce_printorder',
    'area' => 'Paths',
    'editedon' => time(),
), 'key', false)) {
    echo "Error creating commerce_printorder.core_path setting.\n";
}

if (!createObject('modSystemSetting', array(
    'key' => 'commerce_printorder.assets_path',
    'value' => $componentPath.'/assets/components/commerce_printorder/',
    'xtype' => 'textfield',
    'namespace' => 'commerce_printorder',
    'area' => 'Paths',
    'editedon' => time(),
), 'key', false)) {
    echo "Error creating commerce_printorder.assets_path setting.\n";
}
...
$assetsUrl = "{$requestUri}assets/components/commerce_printorder/";

if (!createObject('modSystemSetting', array(
    'key' => 'commerce_printorder.assets_url',
    'value' => $assetsUrl,
    'xtype' => 'textfield',
    'namespace' => 'commerce_printorder',
    'area' => 'Paths',
    ...
    echo "Error creating commerce_printorder.assets_url setting.\n";
}
...
foreach ($settings as $key => $opts) {
    ...
    if (!createObject('modSystemSetting', array(
        ...
        echo "Error creating commerce_printorder.".$key." setting.\n";
    }
}
...
include $componentPath . '/core/components/commerce_printorder/vendor/autoload.php';
